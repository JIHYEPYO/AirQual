...
public class Realchart_Manager {
    ...
    public Realchart_Manager(View view, Context context) {
        ...
        // add empty data
        hChart.setData(data);
        hChart.setVisibleYRangeMaximum(50,YAxis.AxisDependency.LEFT);
        hChart.setDescription("BPM");
        hChart.setDescriptionTextSize(10);

        hChart.setNoDataTextDescription("You need connect to POLAR SENSOR");


        mChart.setDescription("");
        mChart.setTouchEnabled(true);

        mChart.setNoDataTextDescription("You nedd connect to UDOO BOARD");
        mChart.setDragEnabled(true);
        mChart.setScaleEnabled(true);
        mChart.setDrawGridBackground(false);
        mChart.setPinchZoom(true);
        mChart.setDescription("PPB");
    ...
    Hashtable<String,Float> max_value=new Hashtable();
    Hashtable<String,Float> min_value=new Hashtable();
    ...
    public void Set_Data(final Air_Data air) //Top Value , MinValue 수정
    {
        ...
        if(max_value.size()==0)
        {
            ...
            max_value.put("CO",(float)0);
            max_value.put("SO2",(float)0);
            max_value.put("NO2",(float)0);
            max_value.put("O3",(float)0);
            max_value.put("PM",(float)0);
        }
        switch (Util_STATUS.Chart_Select)
        {
            ...
            case "SO2":
            {
                ...
                {
                    max_value.put("SO2",(float)air.so2);
            ...
            case "NO2":
            {
                if(max_value.get("NO2")<air.no2)
                {
                    ...
                    max_value.put("NO2",(float)air.no2);
            ...
            case "PM 2.5":
            {
                ...
                {
                    max_value.put("PM",(float)air.pm2_5);
        ...
        if(min_value.size()==0)
        {
            min_value.put("CO",(float)500);
            min_value.put("SO2",(float)500);
            min_value.put("NO2",(float)500);
            min_value.put("O3",(float)500);
            min_value.put("PM",(float)500);
        ...
        switch (Util_STATUS.Chart_Select)
        {
            ...
            case "SO2":
            {
                ...
                {
                    min_value.put("SO2",(float)air.so2);
            ...
            case "NO2":
            {
                ...
                {
                    min_value.put("NO2",(float)air.no2);
            ...
            case "PM 2.5":
            {
                ...
                {
                    min_value.put("PM",(float)air.pm2_5);
    ...
    private LineDataSet createSet(int count) {
        ...
        switch (count)
        {
            ...
            case 4:
            {
                set= new LineDataSet(null, "PM 2.5");
