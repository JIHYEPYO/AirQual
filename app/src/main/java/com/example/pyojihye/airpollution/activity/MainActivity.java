...
import com.example.pyojihye.airpollution.Send_CSV;
import com.example.pyojihye.airpollution.User_Info;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public static GMap_Manager gmap_manager;
    ...
    private Timer mTimer=null  ; //get realtime data 요청
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //exit SignInActivity
        SignInActivity.ActivitySignIn.finish();
        ...
        TextView textViewUserName = (TextView) header.findViewById(R.id.TextViewNavigationBarUserName);
        String Name = User_Info.UserFirstName + " " +User_Info.UserLastName;
        textViewUserName.setText(Name);

        TextView textViewUserEmail = (TextView) header.findViewById(R.id.TextViewNavigationBarUserEmail);
        textViewUserEmail.setText(User_Info.Email);
        ...
        new Send_CSV(getApplicationContext(),"0ok.txt").uploadFile();
    ...
    public void init() {
        ...
        //
        air_fake_service=new Air_Fake_Service();
    ...
    public static void Go_to_Main()
    {
        ...
        frt.replace(R.id.list_container,fr);
        frt.commit();
            ...
            switch (msg.what) {
                ...
                case MESSAGE_TOAST:
                    ...
                    if(Manage_Adapter.getInstance()!=null)
                    {
                        ...
                        Manage_Adapter.getInstance().UDOOImageview.setImageResource(R.drawable.udoo0);
                        Manage_Adapter.getInstance().UDOOButton.setChecked(false);
                    }
...
//                Log.e(TAG, "Unable to initialize Bluetooth");
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                Log.d("HR DATA",String.valueOf(intent.getStringExtra(BluetoothLeService.EXTRA_DATA)));
                Util_STATUS.SELECT_DEVICE=1;
    ...
    //폴라 센서에서 들어오는 데이터
    private  final Handler polar_Handler =new Handler() //heartlate에서 오는 데이터
    {
        ...
        public void handleMessage(Message msg) {
            ...
            String sql=
                    "INSERT INTO Hr_data(regdate,HR,Lat,Lon) values("
                            +String.valueOf(System.currentTimeMillis()/1000)+","
                            +String.valueOf(msg.getData().getInt("heart"))+","
                            +String.valueOf(gps_manager.get_LatLng().latitude)+","
                            +String.valueOf(gps_manager.get_LatLng().longitude)+
                            ");";
    ...
    //블루투스 매니저에서 들어오는 핸들러
    private  final Handler bluetooth_Handler =new Handler()
    {
        ...
        public void handleMessage(Message msg) {
            ...
            try {
                jsonObject=new JSONObject(msg.getData().getString("data").trim());
                //json을 Air_data로 파싱
                //int time, int co2, int co, int so2, int no2, int pm2_5, int o3,LatLng latLng
                //CO , NO2, O3 ,PM25,SO2,TEMP,TIME
                ar.co=jsonObject.getDouble("CO");
                ar.no2=jsonObject.getDouble("NO2");
                ar.o3=jsonObject.getDouble("O3");
                ar.pm2_5=jsonObject.getDouble("PM25");
                ar.so2=jsonObject.getDouble("SO2");
            ...
            switch(Util_STATUS.NAV_MENU_SELECT)
            {
                ...
                case 4: //realtime map
                {
                    gmap_manager.Set_Circle2(ar,"ME",gps_manager.get_LatLng());
    ...
    public static  final Handler htt_handler=new Handler() {
        @Override
        public void handleMessage(Message msg) { //faek data
            ArrayList<Air_Data> air_dataArrayList=new ArrayList<>();

            try {
                JSONObject jsonObject=new JSONObject(msg.getData().getString("data").trim());
                for(int i=1;i<=jsonObject.getInt("count");i++)
                {
                    Air_Data ar = new Air_Data();
                    JSONObject real_json=jsonObject.getJSONObject("data").getJSONObject(String.valueOf(i));
                    ...
                    ar.co=jsonObject.getJSONObject("data").getJSONObject(String.valueOf(i)).getDouble("CO");
                    ar.no2=jsonObject.getJSONObject("data").getJSONObject(String.valueOf(i)).getDouble("NO2");
                    ar.o3=jsonObject.getJSONObject("data").getJSONObject(String.valueOf(i)).getDouble("O3");
                    ar.pm2_5=jsonObject.getJSONObject("data").getJSONObject(String.valueOf(i)).getDouble("PM");
                    ar.so2=jsonObject.getJSONObject("data").getJSONObject(String.valueOf(i)).getDouble("SO2");
                    ar.temp=jsonObject.getJSONObject("data").getJSONObject(String.valueOf(i)).getInt("TEMP");
                    ar.latLng=new LatLng(jsonObject.getJSONObject("data").getJSONObject("1").getJSONObject("data").getDouble("LATITUDE"),jsonObject.getJSONObject("data").getJSONObject("1").getJSONObject("data").getDouble("LONGITUDE"));
                    gmap_manager.Set_Circle2(ar,jsonObject.getJSONObject("data").getJSONObject("1").getString("userID"),ar.latLng);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
               ...
               */
                ...
                {
                    Util_STATUS.connect_udoo=false;
                    stopConnection();
                    break;
                }
