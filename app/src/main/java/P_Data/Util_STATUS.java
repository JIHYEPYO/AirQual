...
public class Util_STATUS {
    ...
    public static String Map_Select="CO";
    ...
    public static int HELP_VIEW_COUNT=2;
    public static boolean connect_udoo=false;
    public static boolean connect_ble=false;
    /*************
     *
    ...
    public static double AQI_CO;
    public static double AQI_SO2;
    public static double AQI_NO2;
    public static double AQI_O3;
    public static double AQI_PM;
